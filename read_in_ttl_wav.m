...
HLRBat = 'Ovaltine';
session = '2';
root_save = ['C:' filesep 'Users' filesep 'Batman' filesep 'Desktop' filesep 'BatHumanExp' filesep 'box_3' filesep day filesep paradigm filesep strcat('session',session)];
...
% last. 
figure(); hold on; 
plot(t_mic1(end-1000:end),y_mic1(end-1000:end)); xlabel('Seconds'); ylabel('Amplitude');
plot(t_ttl(end-1000:end),y_ttl(end-1000:end)); xlabel('Seconds'); ylabel('Amplitude');
...
deca = load(strcat(root_save,filesep,'decawave_',day,'_',session,'.mat'));
figure(); hold on;
title('Decawave Data');
